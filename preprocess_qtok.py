...
Brian Powell and Robert Schmidt adapted this script based on DrQA's original preprocess.py script,
https://github.com/facebookresearch/DrQA/blob/master/scripts/reader/preprocess.py

Our changes include adding NER and POS for the question tokens, not just the context tokens.
"""
...
out_file = os.path.join(
    args.out_dir, '%s-qtok-%s.txt' % (args.split, args.tokenizer)
)
